  ...
  function formatHelpReport(session) {
    ...
    if (language === 'en') {
      return [
        ...
        !botProvider ? '• `!provider <codex|claude|gemini|kiro|status>` — switch provider for current channel' : null,
        '',
        '**Workspace**',
    ...
    return [
      ...
      !botProvider ? '• `!provider <codex|claude|gemini|kiro|status>` — 切换当前频道 provider' : null,
      '',
      '**工作目录**',
