...
const PROVIDER_CHOICES = new Set(['shared', 'codex', 'claude', 'gemini', 'kiro']);
...
export function buildSendChannelMessageUsage() {
  return [
    'Usage:',
    '  node scripts/send-channel-message.mjs --channel <channel-id> [--content "text" | --content-file <path> | --stdin] [--provider shared|codex|claude|gemini|kiro] [--json]',
    '',
    'Examples:',
